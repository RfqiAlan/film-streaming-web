GET api.php?action=home ke home.json
GET api.php?action=trending ke trending.json
GET api.php?action=movies&page=1 ke movie.json
GET api.php?action=series&page=1 ke series.json

semisal searcing film sugar berisi semua slug yg ada sugarnya 
GET api.php?action=search&q=sugar&page=1

GET api.php?action=detail&slug=sugar-baby-2FsmdIVJ8z5
{
  "success": true,
  "data": {
